...
public class Exercise32 {
	public static void main(String[] args) {
		/*
		 * 메트로폴리스(거대도시)는 다음과 같은
		 * 2가지 조건 중 하나를 만족하여야 한다고 가정한다.
		 * 어떤 도시가 메트로폴리스인지를 알아보는 프로그램을
		 * 작성하여 보자.(삼항연산자 사용)
		...
		//처리
		String metroPoils = (capital == 1) && (population >= 100) || (yearSalary >= 50) ?
					"이 도시는 메트로폴리스입니다." : "이 도시는 메트로폴리스가 아닙니다.";
